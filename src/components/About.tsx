          ...
          >
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8">
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed text-lg">
                <p>
                  Sou Lucio Henrique, desenvolvedor e arquiteto de automações com base em engenharia (SENAI, Una, Anhanguera). Atuei de 2022–2024 em marketing/gestão de tráfego e levei essa visão de funil, origem e mensuração para o que faço hoje: construo fluxos e agentes de atendimento/pré-venda totalmente integrados à WhatsApp API, CRMs (Kommo, HubSpot, GoHighLevel, RD Station CRM) e bancos de dados (SQL/NoSQL, ex.: Postgres/Supabase). Trabalho com n8n/Make, APIs REST e Webhooks, Docker e orquestração de IA (LangChain/LangGraph, RAG, MCP), além de ETL/ELT e dashboards em Power BI/Looker Studio. Também utilizo Python e JavaScript e faço vibe coding (Cursor/Trae) para prototipar rápido. Gosto de transformar processos em sistemas medíveis: registro automático no CRM, follow-ups, handoff humano e painéis de funil/SLA.
                </p>
              </div>
            </div>
          </motion.div>
